...
// mozillaCABundlePEM — снимок набора корневых сертификатов Mozilla/curl
// (https://curl.se/docs/caextract.html, ~119 корней на момент вставки).
// Обновлять руками раз в год-два: перекачать https://curl.se/ca/cacert.pem
// (или зеркало https://github.com/bagder/ca-bundle) и заменить содержимое
// константы целиком.
const mozillaCABundlePEM = `
##
## Bundle of CA Root Certificates
##
## Certificate data from Mozilla as of: Tue Aug 11 21:25:18 2026 GMT
##
